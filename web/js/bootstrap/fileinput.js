...
(function ($) {
    ...
    $.fn.fileinput.defaults = {
        ...
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: 'Archivo "{name}" (<b>{size} KB</b>) excede el tamaño maximo por archvio <b>{maxSize} KB</b>. !',
        msgFilesTooMany: 'Numero de archivos seleccionados para subir <b>({n})</b> excede el limite maximo de <b>{m}</b>. !',
        msgFileNotFound: 'Archivo "{name}" no encontrado!',
        msgFileSecured: 'Security restrictions prevent reading the file "{name}".',
        msgFileNotReadable: 'Archivo "{name}" no permite lectura.',
        msgFilePreviewAborted: 'File preview aborted for "{name}".',
        msgFilePreviewError: 'Un error a ocurrido furante la lectura del archivo "{name}".',
        msgInvalidFileType: 'Tipo no valido para el archivo "{name}". Solo "{types}" son archivos validos.',
        msgInvalidFileExtension: 'Extension no valida para el archivo "{name}". Solo "{extensions}" son archivos validos.',
        msgValidationError: '<span class="text-danger"><i class="glyphicon glyphicon-exclamation-sign"></i> Error al subir el archivo</span>',
