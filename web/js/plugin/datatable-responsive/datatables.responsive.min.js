/*! SmartAdmin - v1.4.1 - 2014-06-22 */"use strict";
...
ResponsiveDatatablesHelper.prototype.init = function (a, b) {
    ...
    if (this.saveState && this.getState(), !this.lastStateExists) {
        ...
        for (var b in this.origBreakpointsDefs)
            a.push({name: b, upperLimit: this.origBreakpointsDefs[b], columnsToHide: []});
        a.sort(function (a, b) {
        ...
        for (d = 0, e = a.length; e > d; d++)
            this.breakpoints[a[d].name] = a[d];
        var f = this.api.columns().header(), g = [];
        for (d = 0, e = f.length; e > d; d++)
            this.api.columns(d).visible() && (this.columnIndexes.push(d), g.push(f[d]));
                ...
                for (var k = j.split(/,\s*/), d = 0; d < k.length; d++) {
                    ...
                    if ("always" === l)
                        for (var b in this.breakpoints)
                            "default" !== this.breakpoints[b].name && this.breakpoints[b].columnsToHide.push(this.columnIndexes[h]);
                    else
                        void 0 !== this.breakpoints[l] && this.breakpoints[l].columnsToHide.push(this.columnIndexes[h])
                }
        }
    }
    ...
    if (!this.disabled) {
        ...
        if (!this.skipNextWindowsWidthChange)
            if (0 === this.lastBreakpoint.length && c.length)
                ...
                f = !0;
            else if (this.columnsHiddenIndexes.length !== c.length)
                f = !0;
            else {
        ...
        for (var b = $("td", a), c = 0, d = b.length; d > c; c++) {
            ...
            if (e = $(e), f === this.expandColumn) {
                if (0 == $("span.responsiveExpander", e).length)
                    switch (e.prepend(this.expandIconTemplate), this.options.clickOn) {
                        case"cell":
