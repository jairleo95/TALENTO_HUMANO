                        ...
                        if (lista.length > 0) {
                            ...
                            $('.btnDel').click(function () {
                                ...
                                $.SmartMessageBox({
                                    ...
                                    content: "Â¿Esta seguro de Eliminar este Centro de Costo?",
                                    buttons: '[No][Si]'
                ...
                $('.btnSave').click(function () {
                    if ($('.btnSave').val() == 1) {
                        $.SmartMessageBox({
                            ...
                            content: "Â¿Esta seguro de crear un nuevo Centro de Costo?",
                            buttons: '[No][Si]'
                        }, function (ButtonPressed) {
                            if (ButtonPressed === "Si") {
                        ...
                        $.SmartMessageBox({
                            ...
                            content: "Â¿Esta seguro de guardar los cambios?",
                            buttons: '[No][Si]'
                        }, function (ButtonPressed) {
                            if (ButtonPressed === "Si") {
