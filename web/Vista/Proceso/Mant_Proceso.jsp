...
<html>
    <head>
        ...
        <script>
            $(document).ready(function () {
                ...
                var b = $(".tbodys");
                function listar() {
                    $.post("../../Proceso", "opc=Listar&t_List=admin", function (objJson) {
                        b.empty();
    ...
    <center>
        ...
        <form  method="post" id="form-plazo" >
            <table>
                <tr><td>Nombre :<td><input type="text" name="nombre_plazo" required="" class="nombre_plazo" /></td></tr>
                <tr><td>Descripcion :<td><textarea name="descripcion" required="" class="descripcion"></textarea></td></tr>
