        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('.del').click(function() {
                    valor = $(this).val();
                    idFuncion = $(".btnIdFun" + valor).val();
                    $.post("../../funcion", "opc=del_funcion" + "&id_fun=" + idFuncion, function() {
                    });
                });
                function listar() {
                        $('.tbodys').append('<input type = "hidden" name = "btnIdFun" class = "btnIdFun<%=i%>" value = "<%=f.getId_fucion()%>" />');
                        $('.tbodys').append('<td class = "num<%=i%>" ><%=(i + 1)%> < /td>');
                        $('.tbodys').append('<td class = "num<%=i%>" ><%=(i + 1)%> < /td>');
                        $('.tbodys').append('<td class = "num<%=i%>" ><%=(i + 1)%> < /td>');
            }
            });
