                            ...
                            <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-custombutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <!--<div class="smart-form" id="form_dgp"  method="post" action="../../contrato">-->
                                                    ...
                                                    <div class="row">
                                                        <section class="col col-2">
                                                            <label class="input" id="titu">Remuneración:
                                                                <input type="text" name="SUELDO"  class="input-group-sm">
                                                            </label>
                                                        </section>
                                                        ...
                                                        <section class="col col-2">
                                                            <label class="input" id="titu">Bono Alimentario:
                                                                <input type="text" name="BONO_ALIMENTO"  class="input-group-sm">
                                                            </label>
                                                        </section>
                                                        <section class="col col-1">
                                                            <label class="input" id="titu">BEV:
                                                                <input type="text" name="BEV"  class="input-group-sm">
                                                            </label>
                                                        </section>

                                                        <section class="col col-2">
                                                            <label class="input" id="titu">Sueldo Total:
                                                                <input type="text" name="TOTAL_SUELDO" value="" class="input-group-sm">
                                                            </label>
                                                        </section>
                                                        <section class="col col-2">
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <div class="smart-form" >
                                            ...
                                            <footer>
                                                ...
                                                <form  method="link" action="Busc_Contrato.jsp"> 
