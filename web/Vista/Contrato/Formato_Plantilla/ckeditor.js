        ...
        (function() {
            ...
            (function() {
                ...
                var f = function(a) {
                    ...
                    for (var l = c, s, C, y, o = j; o < f.length; o++) {
                        ...
                        for (s = s.getNext(); s; ) {
                            if (s.equals(e[o]) || s.equals(d))
                                break;
                            y = s.getNext();
                            if (b == 2)
                                l.append(s.clone(true));
                            else {
                                s.remove();
                                b == 1 && l.append(s)
                            }
                    ...
                    for (c = j; c < e.length; c++) {
                        ...
                        if (!f[c] || s.$.parentNode != f[c].$.parentNode)
                            for (s = s.getPrevious(); s; ) {
                                if (s.equals(f[c]) || s.equals(g))
                                    break;
                                y = s.getPrevious();
                                if (b == 2)
                                    l.$.insertBefore(s.$.cloneNode(true), l.$.firstChild);
                                else {
                                    s.remove();
                    ...
                    shrink: function(a, b, c) {
                        if (!this.collapsed) {
                            ...
                            d.guard = function(b, g) {
                                if (l(b))
                                    return true;
                                if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || g && b.equals(r) || c === false && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary())
                                    return false;
                                !g && b.type == CKEDITOR.NODE_ELEMENT && (r = b);
                                return true
                            };
                            if (i)
                                (g = d[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(g, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
                            if (j) {
                                d.reset();
                        ...
                        for (var d = 0; b; ) {
                            ...
                            if (b.type == CKEDITOR.NODE_ELEMENT)
                                if (b.isEditable()) {
                                    ...
                                    c && (b.is("br") && this.checkEndOfBlock()) &&
            ...
            (function() {
                ...
                b.prototype = {getNextParagraph: function(b) {
                        ...
                        for (this._.nextNode = null; k; ) {
                            ...
                            if (v)
                                k.type == CKEDITOR.NODE_TEXT && a.test(k.getText()) && (v = 0);
                            else {
                                var n = k.getName();
                        ...
                        if (!d) {
                            ...
                            g = {div: 1, th: 1, td: 1};
                            d = d.block;
                            if (!d && k && !this.enforceRealBlocks && g[k.getName()] && i.checkStartOfBlock() && i.checkEndOfBlock() && !k.equals(i.root))
                                d = k;
            ...
            (function() {
                ...
                function f(a) {
                    ...
                    return a._.filterFunction = function(d, e, f, h, k, q, o) {
                        ...
                        if (e) {
                            ...
                            if (f) {
                                n = 0;
                                for (v = f.length; n < v; ++n)
                                    b(f[n], d, e, true, q)
                            }
                            if (t) {
                                n = 0;
                                for (v = t.length; n < v; ++n)
                                    b(t[n], d, e, false, q)
                            }
                            if (!e.valid) {
                                h.push(d);
                            ...
                            if (!e.allAttributes)
                                for (u in v)
                                    if (!q[u])
                                        if (E.test(u)) {
                                            if (u != (w = u.replace(/^data-cke-saved-/, "")) &&
                                                    !q[w]) {
                                                delete v[u];
                                                z = true
                                            }
                ...
                CKEDITOR.filter.prototype = {allow: function(b,
                        ...
                        d.length && (q = true);
                        for (var o, n, a = [], c = ["p", "br", "div"][this.enterMode - 1]; o = d.pop(); )
                                ...
                                if (!c[j]) {
                                    if (q.icons)
                                        for (var k = q.icons.split(","), g = k.length; g--; )
                                            CKEDITOR.skin.addIcon(k[g], q.path + "icons/" + (CKEDITOR.env.hidpi && q.hidpi ? "hidpi/" : "") + k[g] + ".png");
                                    c[j] = 1
                                }
                                if (w) {
                                    w.split && (w = w.split(","));
            ...
            (function() {
                function b(b, c) {
                    ...
                    function o(a, b) {
                        ...
                        if (a.type ==
                            ...
                            if (CKEDITOR.env.ie && q && (!b || a.parent.name in n))
                                return true;
                            if (!q)
                    ...
                    for (u in n)
                        "#"in r[u] || delete n[u];
                    for (u in n)
                        p.elements[u] = k(q, b.config.fillEmptyBlocks !== false);
                    p.root = k(q);
                ...
                var E = /(?:&nbsp;|\xa0)$/, B = "{cke_protected}", r = CKEDITOR.dtd, x = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], z = CKEDITOR.tools.extend({}, r.$blockLimit, r.$block), s = {elements: {}, attributeNames: [[/^on/, "data-cke-pa-on"]]}, C = {elementNames: [[/^cke:/, ""], [/^\?xml:namespace$/, ""]], attributeNames: [[/^data-cke-(saved|pa)-/, ""], [/^data-cke-.*/, ""], ["hidefocus",
                            ""]], elements: {$: function(a) {
                            var b = a.attributes;
                            if (b) {
                                if (b["data-cke-temp"])
                        ...
                        this.setup()
                            ...
                            for (var c = this.editor, d = c.config.enterMode,
                                ...
                                if (!n.checkReadOnly()) {
                                    ...
                                    var x, z;
                                    if (j)
                                        for (; (x = n.getCommonAncestor(0, 1)) && (z = CKEDITOR.dtd[x.getName()]) && (!z || !z[i]); )
                                            if (x.getName()in CKEDITOR.dtd.span)
                                                ...
                                                n.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                                    n.insertNode(m);
                                    l ||
                                            (l = m)
                                }
                            ...
                            if (l) {
                                ...
                                if (j)
                                    if ((b = l.getNext(a)) && b.type == CKEDITOR.NODE_ELEMENT && b.is(CKEDITOR.dtd.$block))
                                        b.getDtd()["#"] ? n.moveToElementEditStart(b) : n.moveToElementEditEnd(l);
                                    ...
                                    if (c in{8: 1, 46: 1}) {
                                        ...
                                        if (e = d(e)) {
                                            ...
                                            if ((h = f.block) && b[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && (j = h[c ? "getPrevious" : "getNext"](i)) && j.is("table")) {
                                                ...
                                                a.fire("saveSnapshot");
                                                g = 1
                                            } else if ((k = f.contains(["td", "th", "caption"])) && b.checkBoundaryOfElement(k, c ? CKEDITOR.START : CKEDITOR.END))
                                                g = 1
                                    }
                                    return!g
                                });
                ...
                var m = function() {
                    ...
                    function c(a, d) {
                        ...
                        for (var n = i[n.getName()], p = 0, j = a.getChildren(), m = j.count(), l = -1, v = -1, E = 0, B = g.contains(i.$list); p < m; ++p) {
                            ...
                            if (b(g)) {
                                ...
                                k.push({isElement: 0, node: g, allowed: 1})
                        }
                        if (l > -1)
                            k[l].firstNotAllowed = 1;
                        if (v > -1)
                            k[v].lastNotAllowed = 1;
                        return k
                    }
                    function d(a, c) {
                        ...
                        for (p && g.push(" "); o < f; o++) {
                            h = e.getItem(o);
                            b(h) &&
                                    !h.is(n) ? g = g.concat(d(h, c)) : g.push(h)
                        }
                        p && g.push(" ");
                        return g
                    }
                    ...
                    return function(n, l, z) {
                        ...
                        if (!C.checkReadOnly()) {
                            ...
                            for (; (D = b(s.startContainer) && s.startContainer.getChild(s.startOffset - 1)) && b(D) && D.isBlockBoundary() && I.contains(D); )
                            ...
                            for (o = u.startNode; (o = o.getParent()) && g(o); )
                                y.push(o);
                            s.moveToBookmark(u);
                            if (u = z) {
                                u = l.range;
                                ...
                                if (/^\s+|\s+$/.test(z) && "span"in CKEDITOR.dtd[D])
                                    var L = '<span data-cke-marker="1">&nbsp;</span>', z = L + z + L;
                                ...
                                if ((L = u.startPath().block) && !(L.getChildCount() == 1 && L.getBogus()))
                                    a:{
                                        var F;
            ...
            (function() {
                ...
                CKEDITOR.dom.selection.prototype = {getNative: function() {
                        ...
                        if (!c || !c.rangeCount)
                            ...
                            if (d == c.endContainer &&
                                    d.nodeType == 1 && c.endOffset - c.startOffset == 1 && w[d.childNodes[c.startOffset].nodeName.toLowerCase()])
                                b = CKEDITOR.SELECTION_ELEMENT
                        }
                        return a.type = b
                    }, getRanges: function() {
                        var a = q ? function() {
                            ...
                            var b = function(b, c) {
                                ...
                                k = k.text.replace(/(\r\n|\r)/g, "\n").length;
                                if (!k)
                                    return{container: d, offset: a(f) + (m > 0 ? 0 : 1)};
                                for (; k > 0; )
                                    try {
                        ...
                        var b = this, c = CKEDITOR.tools.tryThese(function() {
                            ...
                            for (var a = b.getRanges()[0], c, d, e = 2; e && (!(c = a.getEnclosedNode()) || !(c.type == CKEDITOR.NODE_ELEMENT && w[c.getName()] && (d = c))); e--)
                        ...
                        if (a.length)
                            if (this.isLocked) {
                                ...
                                if (q) {
                                    ...
                                    if (m && m.type == CKEDITOR.NODE_ELEMENT && m.getName()in w && (!m.is("a") || !m.getText()))
                                        try {
            ...
            (function() {
                ...
                function w(a) {
                    for (var b = n(this), c = a.getElementsByTag(this.element), d = c.count(); --d >= 0; )
            ...
            (function() {
                function k(a) {
                    ...
                    this.setup();
                    if (CKEDITOR.env.ie)
                        b.getDocumentElement().addClass(b.$.compatMode), d.config.enterMode != CKEDITOR.ENTER_P && b.on("selectionchange", function() {
