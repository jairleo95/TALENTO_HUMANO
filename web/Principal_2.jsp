                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li><a href="menu?opc=logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                            </li>
                        </ul>
                        <!-- /.dropdown-user -->
                    </li>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="#"><i class="fa fa-sitemap fa-fw"></i> Generar Requerimientos<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="#">En Planilla<span class="fa arrow"></span></a>
                                    ...
                                    <li>
                                        <a href="#">(Fuera de Planilla) - Convenio<span class="fa arrow"></span></a>
                                        <ul class="nav nav-third-level">
                                            <li>
                                    ...
                                    <li>
                                        <a href="#">Anulación de Requerimiento<span class="fa arrow"></span></a>
                                        <ul class="nav nav-third-level">
                                            <li>
                                                <a href="#">Item 1</a>
                                            </li>
