                ...
                <ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
                    <li class="">
                        <a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown"> 
                            <img src="HTML_version/img/avatars/sunny.png" alt=" <%out.println((String) sesion.getAttribute("USER")); %>" class="online" />  
                        </a>
                ...
                <ul class="header-dropdown-list hidden-xs">
                    <li>
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li>
                                <a href="javascript:void(0);"><img src="HTML_version/img/blank.gif" class="flag flag-fr" alt="France"> Français</a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"><img src="HTML_version/img/blank.gif" class="flag flag-es" alt="Spanish"> Español</a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"><img src="HTML_version/img/blank.gif" class="flag flag-de" alt="German"> Deutsch</a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"><img src="HTML_version/img/blank.gif" class="flag flag-jp" alt="Japan"> 日本語</a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"><img src="HTML_version/img/blank.gif" class="flag flag-cn" alt="China"> 中文</a>
                            </li>	
                            <li>
        ...
        <aside id="left-panel">
            ...
            <div class="login-info">
                <span> <!-- User image size is adjusted inside CSS, it should stay as it --> 
                    ...
                    <a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
                        <img src="HTML_version/img/avatars/sunny.png" alt="me" class="online" /> 
                        <span>
            ...
            <nav>
                ...
                <ul>
                    ...
                    <%} else {%>
                    <li>
                        <a href="<%=dp.getDi_url()%>" target="myframe"><i class="<%=dp.getIc_link().trim()%>"></i> <%=dp.getNo_link()%></a>
                    </li>
                    <%}
                        }%>
                                    ...
                                    <div class="widget-body widget-hide-overflow no-padding">
                                        ...
                                        <div id="chat-container">
                                            ...
                                            <div class="chat-list-body custom-scroll">
                                                <ul id="chat-users">
                                                    <li>
                                                        <a href="javascript:void(0);"><img src="HTML_version/img/avatars/5.png" alt="">Robin Berry <span class="badge badge-inverse">23</span><span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);"><img src="HTML_version/img/avatars/male.png" alt="">Mark Zeukartech <span class="state"><i class="last-online pull-right">2hrs</i></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);"><img src="HTML_version/img/avatars/male.png" alt="">Belmain Dolson <span class="state"><i class="last-online pull-right">45m</i></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);"><img src="HTML_version/img/avatars/male.png" alt="">Galvitch Drewbery <span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);"><img src="HTML_version/img/avatars/male.png" alt="">Sadi Orlaf <span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);"><img src="HTML_version/img/avatars/male.png" alt="">Markus <span class="state"><i class="last-online pull-right">2m</i></span> </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);"><img src="HTML_version/img/avatars/sunny.png" alt="">Sunny <span class="state"><i class="last-online pull-right">2m</i></span> </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);"><img src="HTML_version/img/avatars/male.png" alt="">Denmark <span class="state"><i class="last-online pull-right">2m</i></span> </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div id="chat-body" class="chat-body custom-scroll">
                                            <ul>
                                                <li class="message">
                                                    <img src="HTML_version/img/avatars/5.png" class="online" alt="">
                                                ...
                                                <li class="message">
                                                    <img src="HTML_version/img/avatars/sunny.png" class="online" alt="">
                                                    <div class="message-text">
                                                        <time>
                                                            2014-01-13
                                                        </time> <a href="javascript:void(0);" class="username"> <%out.println((String) sesion.getAttribute("USER")); %></a> Haha! Yeah I know what you mean. Thanks for the file Sadi! <i class="fa fa-smile-o txt-color-orange"></i> 
                                                    </div>
                                                </li>
                                            </ul>
        ...
        <div class="page-footer">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <span class="txt-color-white">AlfaTeam © 2014</span>
                </div>
