                ...
                <!--<ul class="header-dropdown-list hidden-xs">
                    <li>
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li>
                                <a href="javascript:void(0);"><img src="HTML_version/img/blank.gif" class="flag flag-ru" alt="Russia"> Русский язык</a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"><img src="HTML_version/img/blank.gif" class="flag flag-kp" alt="Korea"> 한국어</a>
                            </li>						
